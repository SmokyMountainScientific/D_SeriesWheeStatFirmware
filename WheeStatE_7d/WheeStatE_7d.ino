...
int pwmRes = 990;  // gives 10 mV resolution, for greater res, increase value changed for E-7c
int halfRes;  // = pwmRes/2;
long readTime;  // time for reading chronoamperometry experiments
int readUnits;
...
/////////// Pin definitions //////////////////////
#define signal_pin  PB_1            // Originaly on PB_4, J1 pin 7
...
#define Vread_pin  A8            //J1, pin 6, Analog read, was A8    
...
long iRead = 0;                 // high pulse current read 
