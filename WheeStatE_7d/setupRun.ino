...
delay(20);
 ...
 // readParam();   
  ...
  if (dB >= 19) {
    gain0 = 0;
    gain1 = hiGain1[dB-19];
 //   gain1 = 2*gain1;  // added for new potentiometers
  }
  else {
    gain1 = 26;
  //  gain1 = 2*gain1;  // added for new potentiometers
    gain0 = loGain0[dB];
    //gain0 = 2*gain0;  // added for new potentiometers
  } 
...
//  readParam();  
  ...
  dOff= dOff1 + offAdj; //  GUI adds 165 to input value (half of 330 digital resolution) 
